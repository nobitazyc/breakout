 ...
 *introduction: this file is the game controller
 */
...
namespace SAGDassignment1
{
    class Game
    {
        ...
        RectangleF userPaddle = new RectangleF(350F, 550F, 100F, 10F);
        RectangleF userPaddle2 = new RectangleF(350F, 550F, 100F, 10F);
        RectangleF ball = new RectangleF(400F, 540F, 10F, 10F);
        RectangleF ball2 = new RectangleF(400F, 540F, 10F, 10F);
        RectangleF wallLeft =new RectangleF(0F,0F,5F,600F);
        RectangleF wallRight = new RectangleF(780F, 0F, 5F, 600F);
        RectangleF wallTop = new RectangleF(0F, 23F, 780F, 5F);
        RectangleF wallBottom = new RectangleF(0F, 560F, 780F, 5F);
        float initialX = 10F;
        float initialY = 100F;
        ...
        public Game(int player)
        {
            ...
            speedX = (float)(r.NextDouble() - 0.5);
            speedY = -0.5F;
            speedX2 = (float)(r.NextDouble() - 0.5);
            speedY2 = -0.5F;
        }
        ...
        public void Draw(PaintEventArgs e)
        {
            ...
            if (twoPlayer == true)
            {
                e.Graphics.FillRectangle(new SolidBrush(Color.FromArgb(255, 176, 85, 116)), userPaddle2);
                e.Graphics.FillEllipse(new SolidBrush(Color.FromArgb(255, 176, 85, 116)), ball2);
            }
            ...
            e.Graphics.DrawString("Mark:" + mark +"                      "+"Life:"+life, new Font("Arial", 20), Brushes.White, 0, 30);
            if (twoPlayer == true)
            {
                e.Graphics.DrawString("Mark:" + mark2 + "                      " + "Life:" + life2, new Font("Arial", 20), Brushes.White, 400, 30);
            }
            int i = 5;
            win = true;
            ...
            if (win == true)
            {
                if (round == 1)
                {
                    ...
                    if (twoPlayer == true)
                    {
                        reset(ref ball2, ref userPaddle2, ref speedX2, ref speedY2);
                    }
                }
                else
        ...
        public bool Update(double elapsedTime)
        {
            ...
            if (twoPlayer == true)
            {
                movePaddle(ref userPaddle2, ref ball2, elapsedTime, left2, right2,start2);
            }
            ...
            if (twoPlayer == true)
            {
                removeBrick(ref ball2, ref mark2, ref speedX2, ref speedY2);
                if (intersect == true)
                {
                    int instantNum = (int)Math.Floor(r.NextDouble() * 10);// 1/15 give the user a stretch
                    if (instantNum == 0)
            ...
            if (twoPlayer == true)
            {
                if (result == true)
                {
                    result = ballIntersect(ref userPaddle2, ref ball2, ref life2, ref speedX2, ref speedY2, ref start2);
                }
            }
            return result;
        }
        ...
        public void changemode()
        {
            switch (gamemode)
            {
                case 1:
                    ...
                    userPaddle2.X = 300;
                    userPaddle2.Width = 200;
                    break;
                case 2:
                    userPaddle.X = 350;
                    userPaddle.Width = 100;
                    userPaddle2.X = 350;
                    userPaddle2.Width = 100;
                    break;
                case 3:
                    userPaddle.X = 375;
                    userPaddle.Width = 50;
                    userPaddle2.X = 375;
                    userPaddle2.Width = 50;
                    break;
            }
        }
